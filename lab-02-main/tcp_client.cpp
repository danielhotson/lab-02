...
{ 
	...
	int rc = connect(sockfd, (const struct sockaddr *)& server_addr, socklen_t addrlen);
	...
	return 0;
// https://www.ibm.com/docs/en/ztpf/1.1.0.15?topic=apis-connect-request-connection-remote-host
//
} 
